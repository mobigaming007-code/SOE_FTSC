      ...
      <div className="space-y-6">
        <section className="fts-hero rounded-[2rem] p-6 text-white md:p-8">
          ...
          <p className="mt-4 max-w-2xl text-sm leading-6 text-sky-50 md:text-base">
            Xem phiếu lương cá nhân, công tính lương, phụ cấp, thưởng, khấu trừ
            và thực nhận.
          </p>
        </section>

        {error ? <ErrorBox message={error} /> : null}
        {loading ? <LoadingBlock text="Đang tải phiếu lương..." /> : null}
          ...
          <>
            <section className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
              <StatCard
                ...
                subtitle="Tổng phiếu lương của tôi"
                icon="💳"
                tone="sky"
              />
              ...
              <StatCard
                ...
                subtitle="Tổng theo các phiếu đang hiển thị"
                icon="💰"
                tone="teal"
              />

              <StatCard
                title="Phiếu mới nhất"
                value={
                  latestPayslip
                ...
                subtitle={
                  latestPayslip
                    ? formatStatus(latestPayslip.trang_thai)
                    : "Chưa có"
                }
                icon="✨"
                tone="gold"
              ...
              <StatCard
                title="Công mới nhất"
                value={formatNumber(latestPayslip?.tong_cong || 0)}
                subtitle="Công tính lương"
                icon="📊"
                tone="navy"
              />
            </section>
              ...
              {payslips.map((payslip) => (
                <div key={payslip.id} className="fts-card rounded-[2rem] p-6">
                  <div className="flex items-start justify-between gap-4">
                    ...
                    <Badge value={payslip.trang_thai} />
                  </div>
